...
!! named source file. Please don't remove "TODO#..." comments.
...
public class TwoScans_TODO { // RBCS_LUSH_demo

  public static void main(String[] args) {

    // TODO1: identify yourself in the start message of the program:
    out.println("Program by: yourFullName, ID: yourSID, labGroup: L?");
    out.println("Scan codes from SID: <xyft1>_<xyft2>\n");
    ...
    while (true) { // Conversation
      ...
      a1.scanRBCS(); // Replace RBCS with your first scan code <xyft1>
      out.println("a1: scanRBCS()");
      a1.indexedPrint();

      a2.scanLUSH(); // Replace LUSH with your cecond scan code <xyft2>
      out.println("a2: scanLUSH()");
      a2.indexedPrint();
...
class Arr2D {
  ...
  public void scanRBCS() {
    int num = rows * cols;
    int startRow = rows - 1, endRow = 0, startCol = cols - 1, endCol = 0;
    int value = 1;
  ...
  public void scanLUSH() {
    int count = 1;

    // First pass: Fill starting from the top-right corner going downwards diagonally
